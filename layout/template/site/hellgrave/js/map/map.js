$(document).ready(function () {
	...
	function printAsideContent(objId, objName, objIcon) {
		...
		imageExists('/layout/template/site/hellgrave/img/map/header_' + imageName + '.jpg', function(exists)
		{
			if(exists)
				$('.map-sidebar-image').css('background-image', 'url(/layout/template/site/hellgrave/img/map/header_' + imageName + '.jpg)');
			else
			{
				$('.map-sidebar-image').css('background-image', 'url(layout/template/site/hellgrave/img/hellgrave_minimap.jpg)');
		...
		if(imageName === "zaken" || imageName === "queen_ant"|| imageName === "frintezza"|| imageName === "baium"|| imageName === "antharass"|| imageName === "valakas"|| imageName === "core"|| imageName === "orfen")
		{
